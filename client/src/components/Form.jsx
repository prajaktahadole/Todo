      ...
      {editFormVisibility===false?(
        <form  onSubmit={handleSubmit}>
          <Stack className='input-and-btn'
                  ...
                  sx={{ m: "40px", boxShadow: "rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset",
                  p: '4px 8px',
                  alignItems: 'center',
                  width: 400 }}>
              <InputBase
          ...
          <Stack className='input-and-btn'
           ...
           boxShadow: "rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset",
              ...
              <Button
               type="submit" 
               variant="contained" 
               endIcon={<UpdateIcon />}>UPDATE</Button>
               
               <Button type="button" 
               sx={{ marginLeft: "15px"  }}
          variant="contained" endIcon={<ArrowBackIcon />}
